<%@ Control Language="vb" AutoEventWireup="false" Inherits="DotNetSysInfoJA.ListeServicesControl" CodeFile="ListeServicesControl.ascx.vb" %>
	...
	<TR>
		<TD>
			<TABLE class="boxheader" cellSpacing="0" cellPadding="4" width="100%" border="0">
				<TR vAlign="top">
					<TD class="boxheader" align="center">Liste des Services</TD>
				<TR height="1">
					<TD height="1" class="interligne"></TD>
				</TR>
				<TR>
					<TD class="SecondNiveau">Liste des Services existant sur la machine</TD>
				</TR>
				<TR>
					<TD class="boxbody">
						<asp:DataGrid id="DataGridListeServices" runat="server" EnableViewState="False" Width="100%" CellPadding="1"
